...
static struct gpiomux_setting tmg200 = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_NONE,
};
...
/* This pin Shooter is not used, do not operate it. */
#if !(defined(CONFIG_MACH_SHOOTER) || defined(CONFIG_MACH_VIGOR) || defined(CONFIG_MACH_VERDI_LTE))
	{
		.gpio      = 44,
		.settings = {
			[GPIOMUX_SUSPENDED] = &gsbi3,
...
static struct msm_gpiomux_config msm8x60_tmg200_configs[] __initdata = {
	{
		.gpio = 61,
		.settings = {
			[GPIOMUX_ACTIVE]    = &tmg200,
			[GPIOMUX_SUSPENDED] = &tmg200,
		},
	},
};
