...
static struct proccomm_regulator_info glacier_pcom_vreg_info[] = {
...
struct proccomm_regulator_platform_data glacier_proccomm_regulator_data = {
	.regs = glacier_pcom_vreg_info,
	.nregs = ARRAY_SIZE(glacier_pcom_vreg_info)
};
