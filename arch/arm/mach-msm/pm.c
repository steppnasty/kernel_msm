...
#define PM_SMSM_WRITE_STATE	SMSM_APPS_DEM
#define PM_SMSM_READ_STATE	SMSM_POWER_MASTER_DEM

#define PM_SMSM_WRITE_RUN	DEM_SLAVE_SMSM_RUN
#define PM_SMSM_READ_RUN	DEM_MASTER_SMSM_RUN
#else
#define PM_SMSM_WRITE_STATE     SMSM_APPS_STATE
#define PM_SMSM_READ_STATE      SMSM_MODEM_STATE
